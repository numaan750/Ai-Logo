...
const Step2Result = ({
  ...
  const generatedImage = formData?.generatedImage || null;
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 hide-scrollbar">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((mockup, index) => (
            ...
            >
              ...
              />
              {generatedImage && logoPositions[index] && (
                <img
                  src={generatedImage}
                  alt="logo overlay"
                  style={{
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    const logoW = (parseFloat(pos.width) / 100) * canvas.width;
                    const logoH =
                      logoW * (logoImg.naturalHeight / logoImg.naturalWidth);
                    const centerX = (parseFloat(pos.left) / 100) * canvas.width;
                    const centerY = (parseFloat(pos.top) / 100) * canvas.height;
