...
export const metadata = {
  title: "Blog – AI Logo Generator",
  description:
    "Read articles and updates about our AI Logo Generator, including how it works, design tips, creative ideas, and guides to make stunning logos effortlessly.",
      ...
      <main className="bg-black text-white">
        <div className="mycontainer py-10 md:py-14">
          <header className="max-w-3xl">
            ...
            <p className="mt-3 text-[16px] sm:text-[18px] text-gray-300">
