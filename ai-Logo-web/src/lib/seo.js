export const BRAND = "Ai Logo Maker:Design Studio";
...
export const seo = {
 us: {
  title: `AI Logo Generator – Create Stunning Logos Instantly | ${BRAND}`,
  description:
    "Design a professional AI-generated logo in seconds with our AI Logo Generator. Fast, easy, and customizable—perfect for startups, brands, and personal projects. Try it free today.",
},
  uk: {
