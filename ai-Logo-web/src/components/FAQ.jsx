    ...
    <div className=" bg-black text-white ">
      <div className="mycontainer  py-15">
        ...
        <p className="-mt-8 mb-10 text-center text-gray-400 text-[14px] sm:text-[16px]">
          ...
          <Link href="/blog" className="underline text-white hover:text-gray-200">
            blog
          </Link>
          {" "}or start with{" "}
          <Link
          ...
          <Link href="/contact" className="underline text-white hover:text-gray-200">
            contact us
          </Link>
          .
        </p>
          ...
          <div className="order-2 md:order-1">
            <div className="space-y-4 ">
              {faqItems.map((faq, index) => (
                <div
                  key={index}
                  className="bg-[#FFFFFF14] rounded-2xl overflow-hidden transition-all duration-300"
                >
                  <button
                  ...
                  >
                    <div className="px-6 pb-5 text-gray-400 text-[16px] sm:text-[16px]">
                      {faq.answer}
                    </div>
                  </div>
                </div>
