    ...
    <>
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="w-7 h-7 sm:w-9 sm:h-9 bg-[#FFA11D] ring-1 ring-[#8C8C8C] ring-offset-2 ring-offset-black cursor-pointer rounded-full flex items-center justify-center shadow-lg"
        >
        ...
        {isOpen && (
          <div className="absolute right-0 top-12 sm:top-14 w-[280px] sm:w-[300px] md:w-[320px] bg-black rounded-xl sm:rounded-2xl shadow-2xl border border-[#0A090C] shadow-md overflow-hidden z-50 animate-slideDown">
            <div className="p-2 sm:p-3 border-b border-[#ffffff40]">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FFA11D] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="py-1 sm:py-2">
              ...
              <Link
                href={
                  "https://apps.apple.com/us/app/ai-logo-maker-design-studio/id6747566522"
                }
                target="_blank"
                className="flex-1 flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 cursor-pointer hover:bg-gray-800/50 transition-all duration-200 group"
              >
              ...
              <button
                ...
                className="w-full cursor-pointer px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2 sm:gap-3 hover:bg-gray-800/50 transition-all duration-200 group"
              >
                <div className="w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center flex-shrink-0">
                  <Image
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
          ...
          ></div>
          <div className="relative bg-gray-900 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 w-[90%] sm:w-[85%] max-w-md animate-popupSlide mx-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <button
                ...
                className="flex-1 px-4 sm:px-6 py-2.5 sm:py-3 cursor-pointer bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-lg sm:rounded-xl text-sm sm:text-base"
              >
                Cancel
              </button>
              <button
